    ...
    def check_metrics(self) -> list[Alert]:
        ...
        if block_rate > self.block_rate_threshold:
            new_alerts.append(Alert(
                ...
                message=f"Block rate {block_rate:.2f} exceeds {self.block_rate_threshold}"
            ))
        ...
        if self.rate_limit_hits > self.rate_limit_hit_threshold:
            new_alerts.append(Alert(
                ...
                message=f"Rate limit hits {self.rate_limit_hits} exceeds {self.rate_limit_hit_threshold}"
            ))
        ...
        if judge_fail_rate > self.judge_fail_rate_threshold:
            new_alerts.append(Alert(
                ...
                message=f"Judge fail rate {judge_fail_rate:.2f} exceeds {self.judge_fail_rate_threshold}"
            ))
